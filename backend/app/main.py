...
from app.api.endpoints import auth, jobs, interviews, tts, admin, users, industries, applications, resume_reviews
...
app.include_router(resume_reviews.router, prefix="/api/v1/resume-reviews", tags=["Resume Reviews"])
